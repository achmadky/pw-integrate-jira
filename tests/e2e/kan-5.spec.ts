...
test.describe('KAN-5: Add Cart and Payment End-to-End Tests', () => {
  ...
  test('KAN-TC-8: Visit Sauce Demo store & navigate to Grey Jacket', { tag: '@KAN-TC-8' }, async ({ catalogPage }) => {
  ...
  test('KAN-TC-9: Add Grey Jacket into cart and proceed to checkout', { tag: '@KAN-TC-9' }, async ({ catalogPage }) => {
